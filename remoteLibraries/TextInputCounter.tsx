...
import { Minus, Plus } from '../assets/discover';
import TextInputCounterBtn from '../src/components/TextInputCounterBtn';
    ...
    if (this.props.type === 'up-down')
      ...
      return (
        <View style={inputContainerStyle}>
          <TextInputCounterBtn
            onPress={this.dec}
            style={[leftButtonStyle, { borderRadius: 6 }]}>
            <Minus
              name="md-remove"
              size={fontSize}
              style={[
          ...
          <TextInputCounterBtn
            onPress={this.inc}
            style={[rightButtonStyle, { borderRadius: 6 }]}>
            <Plus
              name="md-add"
              size={fontSize}
              style={[
